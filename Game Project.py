...
setback = 380
setbock = -200
background = Image(Point(400,300),r"sprites/flapback.gif")
background.draw(win)
obstacle = Image(Point(800,setback),r"sprites/obstacle.gif")
obstacle.draw(win)
obstacle1 = Image(Point(800,setbock),r"sprites/obstacle.gif")
obstacle1.draw(win)
...
kat = Image(Point(400,300),r"sprites/Flappy.gif")
kat.draw(win)
...
while s== 0:
    if g == 0:
        if a < sc:
            a = sc
            print(a)
        menuback = Image(Point(400,300),r"sprites/menu.gif")
        menuback.draw(win)
        ...
        menuback1 = Image(Point(310,475),r"sprites/menup1.gif")
        menuback1.draw(win)
        mtext5 = text(310,475,"Start",35,"Orange",win)
        menuback2 = Image(Point(490,475),r"sprites/menup1.gif")
        menuback2.draw(win)
        mtext6 = text(490,475,"More",35,"Orange",win)
